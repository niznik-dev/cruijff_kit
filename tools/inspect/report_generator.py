...
def generate_report(
    ...
    Args:
        ...
        compute_section: Optional pre-formatted markdown for compute utilization.
            When provided, inserted after "Analysis & Interpretation" section.
    ...
    if future_directions:
        ...
        report_lines.append(
            "*This section is generated by the analyze-experiment skill based on the results above.*\n\n"
        )
    ...
    # Provenance footer
    attribution = (
        f"Generated by {generated_by} via analyze-experiment skill"
        if generated_by
        else "Generated by analyze-experiment skill"
    )
