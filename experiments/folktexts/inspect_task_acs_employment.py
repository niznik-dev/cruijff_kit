"""
Eval task for ACS employment prediction with chat_completion dataset.

Reads prompt and system_prompt from setup_finetune.yaml to ensure train/eval parity.

Usage:
    inspect eval inspect_task_acs_employment.py --model hf/local \
...
def acs_employment(
    ...
    """
    Eval task for ACS employment prediction (employed as civilian) trained with chat_completion.
