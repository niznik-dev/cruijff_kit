...
Then edit `setup_finetune.yaml`. Key parameters to consider changing:
...
├── templates/finetuning/        # Config templates
│   └── setup_finetune_json.yaml # Template for JSON format
├── inspect_task_twins.py        # Inspect-ai evaluation task
├── setup_finetune.yaml          # Created by user (copy from templates/finetuning/)
