"""
LEGACY: Synthetic Twins Zygosity Prediction - Inspect-AI Evaluation Task
...
use inspect_task_twins.py instead.
...
Usage:
    ...
    inspect eval experiments/synthetic_twins/inspect_task_twins_legacy.py --model hf//path/to/model \\
