...
Next, run `python blueprints/capitalization/generate_data.py --word-len 5 --num-words 1000 --output_dir {ck_data_directory}/capitalization/` (you can choose your own params for this part) - this will generate a file like `words_5L_80P_1000.json` in `{ck_data_directory}/capitalization/` with top level splits (train/validation/test) which we will use in finetuning.
...
input_dir_base: {ck_data_directory}/capitalization/
