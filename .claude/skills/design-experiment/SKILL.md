...
- **`data.training.dataset_type` is required** (`"chat_completion"` | `"text_completion"`) — it drives chat-template choice at eval time for every run type, including eval-only
