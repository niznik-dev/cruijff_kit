...
- `evaluation`: system prompt, temperature, do_sample (optional, default false = greedy argmax), scorer (structured list with optional params), tasks, matrix (with optional `compute` block)
