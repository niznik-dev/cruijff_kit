...
**Dataset:**
- Path: `/scratch/gpfs/.../tasks/capitalization/input/words_4L_80P_300.json`
- Format: JSON
...
Details: Path: /scratch/gpfs/MSALGANIK/niznik/GitHub/cruijff_kit/tasks/capitalization/input/words_4L_80P_300.json
