...
- `analysis/report.md` exists (this skill requires `explore` to have run; if missing, stop and tell the user)
...
- **Missing `analysis/report.md`:** stop, suggest running `explore` first.
