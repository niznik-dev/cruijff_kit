...
description: Archive a completed experiment, preserving all experiment files while deleting bulk checkpoint artifacts. Use after summarize-experiment or explore when an experiment is complete and results have been reviewed.
---
...
- **After:** summarize-experiment, explore (when experiment is complete)
