...
- Dataset type: Defaults to `chat_completion` (uses HuggingFace chat templates for train/eval parity). Only override if using other formats like `instruct_dataset`
