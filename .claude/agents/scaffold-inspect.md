...
- Fine-tuned model path: `{base_directory}/{run_name}/artifacts/epoch_{N}`
...
- `output_dir`: `{base_directory}/{run_name}/artifacts/`
...
```bash
OUTPUT_BASE="{base_directory}/{run_name}/artifacts"
