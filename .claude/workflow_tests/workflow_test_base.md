...
- After running `explore`, `analysis/report.md` contains a `## Compute Utilization` header **and** `analysis/compute_metrics.json` exists with at least one entry per submitted job (closes #451 silent-skip gap)
