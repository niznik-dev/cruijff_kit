...
- After running `explore-experiment`, `exploration/report.md` contains a `## Compute Utilization` header and `exploration/compute_utilization.json` exists (closes #451)
