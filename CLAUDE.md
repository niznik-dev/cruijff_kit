...
**Archived** (September 2026): the repository is no longer maintained. Core workflows are functional against the dependency stack in `KNOWN_ISSUES.md`; nothing will change from here.
